...
export const ui: Record<LanguageCode, Record<string, string>> = {
    es: {
        ...
        'header.search.placeholder': 'Buscar en ATARAXIA...',
        ...
        'hero.subtitle': 'ATARAXIA conoce los rincones que los mapas no muestran. Cuéntanos qué buscas y te diseñamos una ruta a la medida de tu alma viajera.',
        ...
        'impact.subtitle': 'Cuando usas ATARAXIA, no solo descubres un destino — contribuyes directamente a la economía de familias veracruzanas.',
        ...
        'story.guide.text': 'ATARAXIA combina datos regionales e inteligencia artificial para recomendaciones de viaje hechas a tu medida: turismo en Veracruz con sentido, sin listas intercambiables.',
        ...
        'testimonials.item1.content': 'Jamás hubiera encontrado la cabaña entre los pinos de Nogales sola. ATARAXIA me llevó exactamente ahí. El café de olla al amanecer fue el momento más auténtico de mi vida.',
        'testimonials.item2.name': 'Carlos R.',
        'testimonials.item2.role': 'Familia de 4, Puebla',
        'testimonials.item2.content': 'Le pregunté a ATARAXIA qué hacer con niños en la zona. En 5 minutos tenía un itinerario perfecto: desde el Pico de Orizaba hasta una chocolatería artesanal en Córdoba.',
        'testimonials.item3.name': 'Sophie L.',
        'testimonials.item3.role': 'Turista internacional, Francia',
        'testimonials.item3.content': 'Le pedí a ATARAXIA cultura de café auténtica y me llevó a una finca pequeña en Huatusco. Los dueños me recibieron como en casa. Por momentos así vale la pena viajar.',
        ...
        'contact.message.placeholder': 'Cuéntanos más sobre tu duda, proyecto o lo que necesitas de ATARAXIA…',
        ...
        'contact.error': 'No se pudo enviar. Intenta de nuevo o escríbenos a ATARAXIAutcv@gmail.com.',
        'contact.modal.title': 'Cuéntanos más',
        'contact.modal.subtitle': 'Tu mensaje llegará directamente al equipo de ATARAXIA.',
        ...
        'faq1.question': '¿ATARAXIA es gratuito para turistas?',
        'faq1.answer': 'Sí. ATARAXIA es completamente gratuito para viajeros. Nuestro modelo de negocio se basa en el apoyo a las MiPyMEs locales, no en cobrarte a ti.',
        'faq2.question': '¿Cómo personaliza ATARAXIA mis recomendaciones?',
        ...
        'faq4.question': '¿Puedo usar ATARAXIA desde mi app móvil?',
        ...
        'about.sectionLabel': 'Sobre ATARAXIA',
        'about.headingPrefix': 'Impulsando el futuro del ',
        'about.headingHighlight': 'Turismo Regional',
        'about.subtitle': 'ATARAXIA es la plataforma de IA ganadora del Galardón Turístico Mi Veracruz 2024, diseñada para revolucionar la forma en que exploramos nuestras montañas.',
        ...
        'pwa.info.company-values.highlight': 'Valores ATARAXIA',
        ...
        'pwa.modal.aboutLabel': 'Sobre ATARAXIA',
    ...
    en: {
        ...
        'header.search.placeholder': 'Search in ATARAXIA...',
        ...
        'hero.subtitle': 'ATARAXIA knows the hidden corners that maps don\'t show. Tell us what you\'re looking for and we\'ll design a route tailored to your traveler\'s soul.',
        ...
        'impact.subtitle': 'When you use ATARAXIA, you\'re not just discovering a destination — you\'re directly contributing to the economy of Veracruz families.',
        'impact.stat1.number': '100',
        'impact.stat1.suffix': '+',
        ...
        'story.guide.text': 'ATARAXIA understands that no two travelers are alike. So it doesn\'t give you a list — it designs a route that breathes Veracruz.',
        'story.cta.label': 'Your adventure starts here',
        'story.cta.title': 'The first step of your journey.',
        'story.cta.text': 'Tell us what kind of experience you\'re looking for. The magic begins when ATARAXIA gets to know you.',
        ...
        'testimonials.item1.content': 'I never would have found the cabin among the Nogales pines on my own. ATARAXIA took me exactly there. The morning coffee at dawn was the most authentic moment of my life.',
        'testimonials.item2.name': 'Carlos R.',
        'testimonials.item2.role': 'Family of 4, Puebla',
        'testimonials.item2.content': 'I asked ATARAXIA what to do with kids in the area. In 5 minutes I had a perfect itinerary: from Pico de Orizaba to an artisan chocolate shop in Córdoba.',
        'testimonials.item3.name': 'Sophie L.',
        'testimonials.item3.role': 'International tourist, France',
        'testimonials.item3.content': 'I told ATARAXIA I wanted to find authentic coffee culture. It sent me to a small farm in Huatusco. The owners became like family. This is why travel exists.',
        ...
        'contact.message.placeholder': 'Tell us more about your question, project, or what you need from ATARAXIA…',
        ...
        'contact.error': 'Could not send. Try again or email us at ATARAXIAutcv@gmail.com.',
        'contact.modal.title': 'Tell us more',
        'contact.modal.subtitle': 'Your message will go directly to the ATARAXIA team.',
        ...
        'faq1.question': 'Is ATARAXIA free for tourists?',
        'faq1.answer': 'Yes. ATARAXIA is completely free for travelers. Our business model is based on supporting local SMEs, not charging you.',
        'faq2.question': 'How does ATARAXIA personalize my recommendations?',
        ...
        'faq4.question': 'Can I use ATARAXIA from my mobile app?',
        'faq4.answer': 'Yes. ATARAXIA is available as a mobile app and also as a web platform. The same smart recommendations on any device.',
        ...
        'about.sectionLabel': 'About ATARAXIA',
        'about.headingPrefix': 'Powering the future of ',
        'about.headingHighlight': 'Regional Tourism',
        'about.subtitle': 'ATARAXIA is the AI platform that won the Mi Veracruz Tourism Award 2024, designed to revolutionize the way we explore our mountains.',
        'about.award.badge': 'Veracruz',
        ...
        'pwa.info.company-values.highlight': 'ATARAXIA Values',
        ...
        'pwa.modal.aboutLabel': 'About ATARAXIA',
    ...
    fr: {
        ...
        'header.search.placeholder': 'Rechercher dans ATARAXIA...',
        ...
        'hero.subtitle': 'ATARAXIA connaît les recoins que les cartes ne montrent pas. Dites-nous ce que vous cherchez et nous concevons un itinéraire sur mesure pour votre âme de voyageur.',
        ...
        'impact.subtitle': 'En utilisant ATARAXIA, vous ne découvrez pas seulement une destination — vous contribuez directement à l\'économie des familles vénézuéliennes.',
        'impact.stat1.number': '100',
        'impact.stat1.suffix': '+',
        ...
        'story.guide.text': 'ATARAXIA comprend qu\'il n\'y a pas deux voyageurs identiques. Il ne vous donne pas une liste — il conçoit un itinéraire qui respire Veracruz.',
        'story.cta.label': 'Votre aventure commence ici',
        'story.cta.title': 'La première étape de votre voyage.',
        'story.cta.text': 'Dites-nous quel type d\'expérience vous recherchez. La magie commence quand ATARAXIA vous connaît.',
        ...
        'testimonials.item1.content': 'Je n\'aurais jamais trouvé le chalet parmi les pins de Nogales seule. ATARAXIA m\'y a emmenée exactement. Le café au lever du soleil fut le moment le plus authentique de ma vie.',
        'testimonials.item2.name': 'Carlos R.',
        'testimonials.item2.role': 'Famille de 4, Puebla',
        'testimonials.item2.content': 'J\'ai demandé à ATARAXIA quoi faire avec des enfants dans la région. En 5 minutes, j\'avais un itinéraire parfait.',
        'testimonials.item3.name': 'Sophie L.',
        'testimonials.item3.role': 'Touriste internationale, France',
        'testimonials.item3.content': 'J\'ai dit à ATARAXIA que je voulais trouver une culture authentique du café. Il m\'a envoyée dans une petite ferme à Huatusco. Les propriétaires sont devenus comme une famille.',
        ...
        'contact.message.placeholder': 'Dites-nous en plus sur votre question, projet ou besoin avec ATARAXIA…',
        ...
        'contact.error': 'Envoi impossible. Réessayez ou écrivez à ATARAXIAutcv@gmail.com.',
        'contact.modal.title': 'Dites-nous en plus',
        'contact.modal.subtitle': 'Votre message ira directement à l\'équipe ATARAXIA.',
        ...
        'faq1.question': 'ATARAXIA est-il gratuit pour les touristes?',
        'faq1.answer': 'Oui. ATARAXIA est entièrement gratuit pour les voyageurs.',
        'faq2.question': 'Comment ATARAXIA personnalise mes recommandations?',
        ...
        'faq4.question': 'Puis-je utiliser ATARAXIA depuis mon application mobile?',
        'faq4.answer': 'Oui. ATARAXIA est disponible en application mobile et en plateforme web.',
        ...
        'about.sectionLabel': 'À propos de ATARAXIA',
        'about.headingPrefix': 'Propulser l\'avenir du ',
        'about.headingHighlight': 'Tourisme régional',
        'about.subtitle': 'ATARAXIA est la plateforme d\'IA lauréate du prix touristique Mi Veracruz 2024, conçue pour révolutionner la façon dont nous explorons nos montagnes.',
        'about.award.badge': 'Veracruz',
        ...
        'pwa.info.company-values.highlight': 'Valeurs ATARAXIA',
        ...
        'pwa.modal.aboutLabel': 'A propos de ATARAXIA',
