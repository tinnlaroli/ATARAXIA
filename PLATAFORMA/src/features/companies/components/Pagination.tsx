                    ...
                    {generatePageNumbers().map((p, index) => {
                        ...
                        return (
                            <button
                                key={p}
                                onClick={() => goToPage(p)}
                                className={`min-w-[32px] h-8 px-2 rounded-md text-sm transition-all duration-200 ${p === page ? 'bg-wellness-50 dark:bg-wellness-50 text-wellness-600 dark:text-wellness-400 font-medium border border-wellness-200 dark:border-wellness-200' : 'text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800 hover:text-zinc-900 dark:hover:text-zinc-300'}`}
                                title={`Ir a página ${p}`}
                            >
                                {p}
                            </button>
            ...
            <div className="flex items-center gap-4 text-xs justify-end">
                <div className="flex items-center gap-2">
                    ...
                    <select
                        ...
                        className="border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 rounded-md px-2 py-1.5 text-xs focus:outline-none focus:ring-1 focus:ring-wellness-500 focus:border-wellness-500 text-zinc-700 dark:text-zinc-300 cursor-pointer transition-colors"
                    >
